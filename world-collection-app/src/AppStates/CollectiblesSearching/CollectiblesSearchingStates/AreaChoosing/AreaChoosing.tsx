        ...
        <>
            <h1>Choose the way of selecting area, in which collectibles will be searched.</h1>
                <div className="d-flex flex-row">
                    ...
                    <CardForArea imgSrc="/Images/administrative_area_image.png" title="Administrative Area" text="Seach for administrative area in world. It will search for collectibles, which lies in this administrative area." areaType={Areas.ADMINISTRAVIVE_AREA} handleSelection={handleSelection} />
