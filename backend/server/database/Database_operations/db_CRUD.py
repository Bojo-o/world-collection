...
def get_all_collectibles_in_collection(collection_id : int):
    ...
    if data is None:
        print(f'Error with obtaining all collectibles in collection with ID : {collection_id}') 
    return data
...
def update_collectible_collection(q_number : int,collection_id : int,new_collection_id : int):
    ...
    if status is True:
        print(f'Update collection of collectible with Q number : {q_number} , which was in collection with id : {collection_id}')
    return status
...
def update_collectible_visit_date(q_number : int,date_format : str = None,date_from: str = None,date_to : str = None) :
    ...
    if status is True:
        print(f'Update date of visit of the collectible with Q number : {q_number}')
    return status
# icon
